...
export default function ReviewForm({
  ...
  return (
    <div className="flex flex-col h-full bg-neutral-950/80 backdrop-blur-xl border border-neutral-800/80 rounded-2xl p-6 sm:p-8 text-white overflow-y-auto custom-scrollbar shadow-2xl">
      {/* Header */}
      ...
      <form onSubmit={handleSubmit} className="flex-1 flex flex-col space-y-6 sm:space-y-8">
          ...
          <div className="flex items-center justify-center gap-2 my-2">
            {[1, 2, 3, 4, 5].map((star) => {
              ...
              return (
                ...
                >
                  <svg
                    className={`w-10 h-10 sm:w-11 h-11 transition-colors duration-150 ${
                      active
        ...
        {showDetailed && (
          <div className="space-y-6 sm:space-y-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  ...
                  <button
                    ...
                    className={`flex flex-col items-center justify-center py-3 px-2 sm:py-4 sm:px-3 rounded-xl border transition-all active:scale-[0.98] min-h-[72px]
                      ${
                  ...
                  >
                    ...
                    <span className="text-[15px] text-neutral-500 mt-1">{item.desc}</span>
                  </button>
                ))}
              </div>
            </div>
            ...
            <div className="space-y-3 p-4 sm:p-5 bg-neutral-900/30 border border-neutral-800/40 rounded-xl">
              <div className="flex justify-between items-center text-[18px] font-bold mb-1">
                <span className="text-neutral-400 uppercase tracking-widest">Relative Prices</span>
              ...
              <input
                ...
                className="w-full h-2 bg-neutral-800 rounded-lg appearance-none cursor-pointer accent-amber-500 focus:outline-none py-1"
              />
            </div>
            ...
            <div className="space-y-4 p-4 sm:p-5 bg-neutral-900/30 border border-neutral-800/40 rounded-xl">
              <label className="block text-[18px] font-bold uppercase tracking-widest text-neutral-400 mb-1">
                Drink Purchase details (Optional)
              </label>
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full bg-amber-500 hover:bg-amber-400 text-neutral-950 font-black py-4 px-6 rounded-xl transition-all active:scale-[0.98] shadow-lg shadow-amber-500/10 disabled:opacity-50 disabled:active:scale-100 flex items-center justify-center mt-6 text-[18px] min-h-[56px]"
        >
          {submitting ? (
